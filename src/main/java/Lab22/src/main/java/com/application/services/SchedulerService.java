...
public class SchedulerService {
    ...
    public void toFile() throws IOException{
        ...
        for(File myFile : new File("/Users/felikstitov/IdeaProjects/Java_labs_patterns/src/main/java/Lab22/Data").listFiles())
            if (myFile.isFile())
                myFile.delete();


        File file = new File("/Users/felikstitov/IdeaProjects/Java_labs_patterns/src/main/java/Lab22/Data/student.txt");
        file.createNewFile();
        ...
        file = new File("/Users/felikstitov/IdeaProjects/Java_labs_patterns/src/main/java/Lab22/Data/university.txt");
        file.createNewFile();
